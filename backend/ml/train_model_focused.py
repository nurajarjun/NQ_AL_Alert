...
logger = logging.getLogger("TRAIN_FOCUSED")

def train():
    logger.info("Loading Focused Data...")
    df = pd.read_csv("backend/data/training_data_focused.csv", index_col=0, parse_dates=True)
    ...
    logger.info("✅ Focused Training Complete.")
